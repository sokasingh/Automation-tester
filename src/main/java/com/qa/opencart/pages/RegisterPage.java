...
public class RegisterPage {
	...
	{
		eleUtil.doSendKeysWithWait(this.firstName, AppConstants.DEFAULT_LARGE_TIME_OUT, firstName);
		...
		System.out.println("Success Messag=====>" + succMesg);
		
		
		//eleUtil.doClickWithWait(logoutLink, AppConstants.DEFAULT_LARGE_TIME_OUT);
